...
// const renderPriceComparator = ({data}) => {
  ...
  //   //   setExpandedCard(product); // Set the product to be expanded
  ...
  //                                 setShowBankOffers(true);
  //                               }}
  //                               className="bg-blue-500 text-white p-2 rounded hover:bg-blue-600 transition flex items-center mb-2"
  //                             >
  //                               <CreditCard className="mr-2" size={16} /> Offers
  //                             </button>
  //                             <a
